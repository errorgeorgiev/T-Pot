#!/bin/bash
# T-Pot-OPSEC Universal Installer
...
myBACKTITLE="T-Pot-OPSEC-Installer"
...
myINFO="\
###############################################
### T-Pot OPSEC Installer for Debian (Stable) ###
###############################################
...
if ! [ "$myTPOT_DEPLOYMENT_TYPE" == "iso" ];
  then
    ...
    ### DEV
    git clone https://github.com/errorgeorgiev/T-Pot.git /opt/tpot
fi
